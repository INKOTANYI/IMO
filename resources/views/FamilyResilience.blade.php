...
<head>
    ...
    <meta name="description" content="Family Resilience and Economic Empowerment - Izere Mubyeyi Organization NGO"/>
    <meta name="keywords" content="disability, family resilience, economic empowerment, peer support, entrepreneurship, Rwanda"/>
    ...
    <meta property="og:description" content="Discover Izere Mubyeyi Organization’s Family Resilience and Economic Empowerment program, strengthening families of children with disabilities through peer support, entrepreneurship training, and income-generating activities in Rwanda."/>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            <div class="card">
                                <div class="card-body">
                                    <p class="lead mb-30">At Izere Mubyeyi Organization, we recognize that strong, empowered families are the cornerstone of inclusive development. Children with intellectual disabilities thrive when their families are supported, confident, and equipped with the resources to meet their needs. Our Family Resilience and Economic Empowerment program is designed to strengthen families both socially and economically, enabling them to provide better care for their children while contributing meaningfully to Rwanda’s socio-economic growth.</p>
                                    <div class="program-item">
                                        <h4>Key Components of Our Program</h4>
                                        <ul>
                                            <li><strong>Peer Support Groups:</strong> We facilitate parent and caregiver support groups where families can share experiences, exchange advice, and build emotional resilience. These groups foster solidarity, reduce isolation, and create a community of mutual encouragement, empowering families to face the challenges of raising children with disabilities together.</li>
                                            <li><strong>Entrepreneurship Training:</strong> Parents and caregivers receive practical training in entrepreneurship, covering skills such as business planning, financial management, and market access. This equips them to start or strengthen small businesses that generate sustainable income, increasing their capacity to support their children’s education, health, and overall development.</li>
                                            <li><strong>Income-Generating Activities:</strong> Families are supported to engage in practical income-generating projects, from agriculture and crafts to small-scale trade. These activities enhance household income, promote financial independence, and reduce economic vulnerability, allowing families to focus on their children’s growth and well-being.</li>
                                            <li><strong>Gender Inclusion:</strong> We ensure that both mothers and fathers, as well as female and male caregivers, are equally empowered to participate in peer support groups, entrepreneurship training, and income-generating activities. By actively promoting gender inclusion, we strengthen family decision-making, enhance equitable access to resources, and create a supportive environment where all parents can contribute fully to their children’s development and the family’s socio-economic progress.</li>
                                        </ul>
                                    </div>
                                    <div class="program-item">
        ...
        <section class="section" data-tm-bg-color="#f2f3f5">
            <div class="container pt-60 pb-60">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-theme-colored1 mb-30">Partner with Us</h2>
                            <p class="lead mb-30">Join us in expanding peer support initiatives, enhancing entrepreneurship training, and providing resources for income-generating projects to help families become self-reliant and inclusive.</p>
                            <a href="{{ route('donate') }}" class="btn btn-theme-colored2 btn-lg">Support Our Mission</a>
                        </div>
                    </div>
                </div>
            </div>
