...
<head>
    ...
    <meta property="og:title" content="Our Mission and Vision - Izere Mubyeyi Organization NGO"/>
    <meta property="og:description" content="Learn about Izere Mubyeyi Organization’s mission and vision to promote inclusion and empowerment for children and youth with intellectual disabilities in Rwanda."/>
    <meta property="og:image" content="{{ asset('images/bg/Logo-izere.png') }}"/>
    <meta property="og:url" content="{{ url('/mission-vision') }}"/>
    <meta name="twitter:card" content="summary_large_image"/>

    <!-- Page Title -->
    <title>Our Mission and Vision - Izere Mubyeyi Organization NGO</title>
...
<div id="wrapper" class="clearfix">
    ...
    <!-- Main Content -->
    <div id="main-content">
        <!-- Mission and Vision Hero Section -->
        <section class="section" data-tm-bg-color="#0052A5">
            <div class="container pt-40 pb-20">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-4">Our Mission and Vision</h1>
                            <p class="text-white lead">Guiding Our Commitment to Inclusion and Empowerment</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Mission and Vision Content Section -->
                                ...
                                <div class="card-body">
                                    <div class="content-section">
                                        ...
                                        <div class="mission-vision-card">
                                            <h5><i class="fas fa-bullseye"></i> Mission</h5>
                                        ...
                                        <div class="mission-vision-card">
                                            <h5><i class="fas fa-eye"></i> Vision</h5>
                                            <p>A Rwanda free from discrimination, where children and youth with intellectual disabilities and learning difficulties, together with their families, are fully included, empowered, and able to thrive and participate equally in all aspects of society.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="lead mb-30">Support our mission and vision by partnering with us to create a more inclusive Rwanda for children with disabilities.</p>
