...
<head>
    ...
    <meta name="description" content="Izere Mubyeyi Organization - Empowering Children with Disabilities through Essential Health Care"/>
    <meta name="keywords" content="health care, disability, physiotherapy, occupational therapy, psychosocial support, Rwanda"/>
    <meta name="author" content="Izere Mubyeyi Organization"/>
    <meta property="og:title" content="Essential Health Care - Izere Mubyeyi Organization NGO"/>
    <meta property="og:description" content="Learn about Izere Mubyeyi Organization’s Essential Health Care program, providing screening, rehabilitation, and psychosocial support for children with disabilities in Rwanda."/>
    <meta property="og:image" content="{{ asset('images/bg/Logo-izere.png') }}"/>
    <meta property="og:url" content="{{ url('/health-care') }}"/>
    <meta name="twitter:card" content="summary_large_image"/>

    <!-- Page Title -->
    <title>Essential Health Care - Izere Mubyeyi Organization NGO</title>
...
<div id="wrapper" class="clearfix">
    ...
    <!-- Main Content -->
    <div id="main-content">
        <!-- Health Care Hero Section -->
        <section class="section" data-tm-bg-color="#0052A5">
            <div class="container pt-40 pb-20">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-4">Essential Health Care</h1>
                            <p class="text-white lead">Supporting Health for Inclusion and Growth</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="content-section">
                                        <h4>Our Health Care Program</h4>
                                        <div class="health-card">
                                            <h5><i class="fas fa-stethoscope"></i> Program Overview</h5>
                                            <p>At Izere Mubyeyi Organization, we understand that health is the foundation for learning, growth, and inclusion. Children and youth with intellectual disabilities often face unique physical, cognitive, and emotional challenges that require specialized care. Our Essential Health Care program is designed to identify these needs early, provide essential interventions, and support families in navigating the health journey of their children.</p>
                                        </div>
                                        <div class="health-card">
                                            <h5><i class="fas fa-heartbeat"></i> Key Components of Our Health Care Program</h5>
                                            <ol>
                                                <li><strong>Screening and Identification:</strong>
                                                    <ul>
                                                        <li>We proactively screen and identify vulnerable children and youth with intellectual disabilities in our community, ensuring early detection of health and developmental needs.</li>
                                                        <li>This process allows us to design personalized interventions that maximize each child’s potential.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Rehabilitation Services:</strong>
                                                    <ul>
                                                        <li>Our Physiotherapy and Occupational Therapy programs improve mobility, coordination, and functional independence.</li>
                                                        <li>Children receive therapies tailored to their abilities, enabling them to participate fully in school, home, and community activities.</li>
                                                        <li>Where advanced care is needed, we facilitate referrals to specialized health facilities, ensuring continuity and quality of care.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Psycho-Social Support:</strong>
                                                    <ul>
                                                        <li>We provide ongoing counseling and psychosocial support to parents, caregivers, and teachers, helping them cope with challenges, reduce stress, and build confidence in caring for children with disabilities.</li>
                                                        <li>This component strengthens family resilience and improves learning outcomes for the children.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>First-Aid Services:</strong>
                                                    <ul>
                                                        <li>Our center is equipped to provide immediate first-aid care for minor injuries and health concerns, creating a safe environment where children can learn and play without fear.</li>
                                                    </ul>
                                                </li>
                                            </ol>
                                        </div>
                                        <div class="health-card">
                                            <h5><i class="fas fa-star"></i> Why Our Health Program is Unique</h5>
                                            <ul>
                                                <li>It integrates physical, emotional, and social support in one all-inclusive approach.</li>
                                                <li>Focuses on early detection and individualized care, ensuring children receive timely interventions that enhance development and inclusion.</li>
                                                <li>Supports not only children but also families and teachers, recognizing that community-wide support is essential for sustainable impact.</li>
                                            </ul>
                                        </div>
                                        <div class="health-card">
                                            <h5><i class="fas fa-handshake"></i> Partner with Us to Build a Healthier, Inclusive Future</h5>
                                            <p>We invite government bodies, private sector partners, civil society, local, regional, and international donors to collaborate with us. Your support allows us to expand screening initiatives, hire specialized therapists, provide assistive devices, and strengthen psychosocial services, helping children with disabilities thrive, families flourish, and communities embrace inclusion.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="section" data-tm-bg-color="#f2f3f5">
            <div class="container pt-60 pb-60">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-theme-colored1 mb-30">Support Health and Inclusion</h2>
                            <p class="lead mb-30">Partner with us to provide essential health care for children with disabilities in Rwanda.</p>
