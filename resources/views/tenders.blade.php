                                    ...
                                    @foreach ([
                                        ...
                                        <li data-index="rs-{{ $loop->index + 1 }}" data-transition="slidedown" data-slotamount="default" data-easein="Power2.easeInOut" data-easeout="Power2.easeInOut" data-masterspeed="600" data-thumb="{{ asset('images/bg/' . $image) }}" data-rotate="0" data-saveperformance="on" data-title="Slide {{ $loop->index + 1 }}">
                                            ...
                                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                                ...
                                                <a href="{{ route('volunteer-form') }}" class="btn btn-slider btn-slider-secondary mr-10" style="font-family: 'Roboto', sans-serif;" aria-label="Join Us">Join Us</a>
                                                <a href="https://wa.me/250786721626" class="btn btn-slider" style="background-color: #25D366 !important; color: #FFFFFF !important; font-family: 'Roboto', sans-serif;" target="_blank" rel="noopener" aria-label="WhatsApp Chat">WhatsApp</a>
                                            </div>
                                        </li>
                                    @endforeach
                                </ul>
