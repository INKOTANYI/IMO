        ...
        <section class="section" data-tm-bg-color="#f2f3f5">
            <div class="container pt-60 pb-60">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-theme-colored1 mb-30">Support Community Inclusion</h2>
                            <p class="lead mb-30">Partner with us to empower communities and create inclusive environments for children with disabilities.</p>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="widget widget-contact-info">
                            ...
                            <div class="tm-widget tm-widget-contact-info contact-info contact-icon-theme-colored1">
                                <div class="thumb">
