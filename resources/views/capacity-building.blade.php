        ...
        <section class="section" data-tm-bg-color="#f2f3f5">
            <div class="container pt-60 pb-60">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-theme-colored1 mb-30">Support Community Empowerment</h2>
                            <p class="lead mb-30">Partner with us to build inclusive communities where every child thrives.</p>
