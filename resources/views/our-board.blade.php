...
<head>
    ...
    <meta property="og:title" content="Our Board - Izere Mubyeyi Organization NGO">
    <meta property="og:description" content="Meet the dedicated board members guiding Izere Mubyeyi Organization’s mission to empower children with disabilities in Rwanda.">
    <meta property="og:image" content="{{ asset('images/bg/Logo-izere.png') }}">
    <meta property="og:url" content="{{ url('/our-board') }}">
    <meta name="twitter:card" content="summary_large_image">

    <!-- Page Title -->
    <title>Our Board - Izere Mubyeyi Organization NGO</title>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-4">Our Board</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="board-content">
                                        ...
                                        <h4>Jane Smith - Treasurer</h4>
                                        <p>Jane, a financial expert, ensures our resources are managed effectively to maximize impact for the communities we serve.</p>
                                        -->
                                    </div>
                                </div>
                            </div>
