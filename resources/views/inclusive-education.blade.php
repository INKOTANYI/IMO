...
<head>
    ...
    <meta name="description" content="Izere Mubyeyi Organization - Empowering Children with Disabilities through Inclusive Education"/>
    <meta name="keywords" content="inclusive education, special needs, disability, education, Rwanda, vocational training"/>
    <meta name="author" content="Izere Mubyeyi Organization"/>
    <meta property="og:title" content="Inclusive and Special Needs Education - Izere Mubyeyi Organization NGO"/>
    <meta property="og:description" content="Discover Izere Mubyeyi Organization’s Inclusive and Special Needs Education program, empowering children with and without intellectual disabilities to learn and thrive in Rwanda."/>
    <meta property="og:image" content="{{ asset('images/bg/Logo-izere.png') }}"/>
    <meta property="og:url" content="{{ url('/inclusive-education') }}"/>
    <meta name="twitter:card" content="summary_large_image"/>

    <!-- Page Title -->
    <title>Inclusive and Special Needs Education - Izere Mubyeyi Organization NGO</title>
...
<div id="wrapper" class="clearfix">
    ...
    <!-- Main Content -->
    <div id="main-content">
        <!-- Inclusive Education Hero Section -->
        <section class="section" data-tm-bg-color="#0052A5">
            <div class="container pt-40 pb-20">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-4">Inclusive and Special Needs Education</h1>
                            <p class="text-white lead">Empowering Every Child to Learn and Thrive</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Inclusive Education Content Section -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="content-section">
                                        <h4>Our Inclusive Education Program</h4>
                                        <div class="education-card">
                                            <h5><i class="fas fa-graduation-cap"></i> Program Overview</h5>
                                            <p>At Izere Mubyeyi Organization, we run a Special Needs and Inclusive Early Childhood and Primary Education Center. We believe that every child has the right to learn, grow, and succeed, regardless of ability. Our Special Needs and Inclusive Education program is designed to provide a safe, nurturing, and stimulating environment where children with and without intellectual disabilities can thrive together. This approach not only develops academic skills but also fosters social integration, empathy, and respect from an early age.</p>
                                        </div>
                                        <div class="education-card">
                                            <h5><i class="fas fa-chalkboard-teacher"></i> What Makes Our Program Unique</h5>
                                            <ul>
                                                <li><strong>Individualized Learning:</strong> We apply special needs and inclusive teaching methodologies tailored to the abilities and needs of each learner. Our curriculum is adapted to ensure that children receive the support they require while being challenged to reach their full potential.</li>
                                                <li><strong>Inclusive Classrooms:</strong> We bring together children with and without disabilities in inclusive nursery classes (Baby, Middle, and Top) and inclusive primary classes (P1–P3, with P4 starting this year). This integrated learning environment encourages interaction, understanding, and mutual respect among all children.</li>
                                                <li><strong>Specialized Support:</strong> Children with intellectual disabilities attend Special Needs Classes designed for different age groups: 6–9 years and 10–12 years. Each class is carefully structured to provide focused attention and therapeutic support as needed.</li>
                                                <li><strong>Vocational Training for Youth:</strong> Our program also includes a vocational workshop for youth with intellectual disabilities, where they learn arts, handcrafts, and practical skills. This empowers them with creativity, confidence, and opportunities for future employment or entrepreneurship.</li>
                                                <li><strong>National Standards Compliance:</strong> We follow the Rwanda National School Year Calendar and adhere to educational standards while innovatively adapting curricula and teaching strategies to meet the diverse needs of our learners.</li>
                                            </ul>
                                        </div>
                                        <div class="education-card">
                                            <h5><i class="fas fa-users"></i> Why Parents and Communities Trust Us</h5>
                                            <p>Our center is more than a school, it is a community of learning, care, and opportunity. Parents see their children gain confidence, learn life skills, and build friendships in an environment that celebrates every child’s abilities. Communities benefit as children grow into inclusive, empathetic, and capable members of society.</p>
                                        </div>
                                        <div class="education-card">
                                            <h5><i class="fas fa-handshake"></i> Partner with Us to Build Inclusive, Bright Futures</h5>
                                            <p>We invite government institutions, private sector actors, civil society organizations, and donors at local, regional, and international levels to partner with us. Your support enables us to:</p>
                                            <ul>
                                                <li>Expand our inclusive classrooms and vocational workshops.</li>
                                                <li>Train more teachers and caregivers in special needs education.</li>
                                                <li>Provide learning materials, assistive devices, and adaptive resources for our children.</li>
                                                <li>Conduct outreach to identify and enroll more children with disabilities who are often hidden or excluded.</li>
                                            </ul>
                                            <p>By supporting our program, you help create a society where no child is left behind, where abilities are celebrated, and where every young person can thrive. Together, we can build an educational model that transforms lives, strengthens families, and shapes inclusive communities across Rwanda and beyond.</p>
                                        </div>
                                        <div class="education-card">
                                            <h5><i class="fas fa-info-circle"></i> Eligibility Criteria and Enrollment Process</h5>
                                            <p>At Izere Mubyeyi Organization, we welcome children with and without intellectual disabilities who are ready to learn, grow, and thrive in an inclusive environment. Our goal is to ensure that every child who can benefit from our programs has access to quality education and support.</p>
                                            <h6>Eligibility Criteria</h6>
                                            <ol>
                                                <li><strong>Age Requirements:</strong>
                                                    <ul>
                                                        <li><strong>Special Needs Classes:</strong>
                                                            <ul>
                                                                <li>Class 1: 6–9 years old</li>
                                                                <li>Class 2: 10–12 years old</li>
                                                            </ul>
                                                        </li>
                                                        <li><strong>Inclusive Nursery Classes:</strong> Baby, Middle, and Top Class (typically ages 3–5)</li>
                                                        <li><strong>Inclusive Primary Classes:</strong> P1, P2, P3 (P4 starting this year; ages 6–12)</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Intellectual and Developmental Assessment:</strong>
                                                    <ul>
                                                        <li>Children with identified intellectual or developmental disabilities are eligible for special needs classes, based on professional assessment by a qualified psychologist, therapist, or special needs educator.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Readiness to Learn:</strong>
                                                    <ul>
                                                        <li>Children should be able to participate in class routines and engage in learning activities with appropriate support.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Commitment from Parents/Caregivers:</strong>
                                                    <ul>
                                                        <li>Families should demonstrate willingness to actively participate in their child’s learning, attend meetings, and collaborate with teachers and therapists to support progress.</li>
                                                    </ul>
                                                </li>
                                            </ol>
                                            <h6>Enrollment Process</h6>
                                            <ol>
                                                <li><strong>Inquiry and Information Session:</strong>
                                                    <ul>
                                                        <li>Parents or guardians contact the school via phone, email, or in person to request information. They may attend an information session to learn about the programs, facilities, and support services.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Application Submission:</strong>
                                                    <ul>
                                                        <li>Complete an enrollment form, providing details about the child’s age, health, and any existing assessments or reports on intellectual or developmental needs.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Assessment and Interview:</strong>
                                                    <ul>
                                                        <li>Children enrolling in special needs classes undergo a preliminary assessment by our special needs educators or therapists to understand learning requirements and design an individualized support plan.</li>
                                                        <li>For inclusive classes, teachers meet with the family to discuss expectations, learning objectives, and integration strategies.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Admission Decision:</strong>
                                                    <ul>
                                                        <li>Based on assessments and class availability, families receive confirmation of enrollment along with guidance on class placement and schedule.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Orientation:</strong>
                                                    <ul>
                                                        <li>Parents and children attend an orientation session to familiarize themselves with school routines, teaching methodologies, and support services.</li>
                                                    </ul>
                                                </li>
                                                <li><strong>Commencement of Classes:</strong>
                                                    <ul>
                                                        <li>Children start their academic year following the Rwanda National School Year Calendar, fully supported by teachers, therapists, and staff.</li>
                                                    </ul>
                                                </li>
                                            </ol>
                                            <h6>Support for Families</h6>
                                            <ul>
                                                <li>Families of children with disabilities may access therapy, counseling, and guidance to complement learning at school.</li>
                                                <li>Regular parent-teacher meetings ensure children’s progress is monitored, and interventions are adapted as needed.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="section" data-tm-bg-color="#f2f3f5">
            <div class="container pt-60 pb-60">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-theme-colored1 mb-30">Support Inclusive Education</h2>
                            <p class="lead mb-30">Partner with us to empower every child to learn, grow, and thrive in an inclusive Rwanda.</p>
