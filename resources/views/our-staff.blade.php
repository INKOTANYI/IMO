...
<head>
    ...
    <meta property="og:title" content="Our Staff - Izere Mubyeyi Organization NGO"/>
    <meta property="og:description" content="Meet the dedicated team at Izere Mubyeyi Organization, working tirelessly to empower children with disabilities in Rwanda through education, health, and advocacy."/>
    <meta property="og:image" content="{{ asset('images/bg/Logo-izere.png') }}"/>
    <meta property="og:url" content="{{ url('/our-staff') }}"/>
    <meta name="twitter:card" content="summary_large_image"/>

    <!-- Page Title -->
    <title>Our Staff - Izere Mubyeyi Organization NGO</title>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-4">Our Staff</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="content-section">
                                        <p>Behind every milestone at Izere Mubyeyi Organization is a team of dedicated professionals and passionate changemakers who bring our vision to life each day. Our staff is made up of educators, therapists, social workers, program managers, and support personnel, each united by a shared commitment to inclusion, dignity, and empowerment for children and youth with disabilities.</p>
                                        <p>What sets our team apart is not only their professional expertise but also their heartfelt dedication. They go beyond delivering services. They listen, they guide, and they walk hand-in-hand with children, parents, and communities to break barriers and unlock potential. From classrooms to therapy rooms, from community outreach to policy advocacy, our staff embodies resilience, compassion, and innovation.</p>
                                        <p>Together, they form the backbone of the organization, turning the dreams of our founders into daily realities and ensuring that every child and family we serve experiences hope, support, and opportunity.</p>
                                        <!-- Staff Members -->
                                        <div class="staff-grid">
                                            <div class="staff-card">
                                                <img src="{{ asset('images/staff/alice-mukamana.jpg') }}" alt="Alice Mukamana, Program Director at Izere Mubyeyi Organization">
                                                <h5>Alice Mukamana</h5>
                                                <p>Program Director</p>
                                                <p>Alice oversees our inclusive education programs, bringing 15 years of experience in special needs education to empower children with disabilities.</p>
                                            </div>
                                            <div class="staff-card">
                                                <img src="{{ asset('images/staff/peter-kagabo.jpg') }}" alt="Peter Kagabo, Lead Therapist at Izere Mubyeyi Organization">
                                                <h5>Peter Kagabo</h5>
                                                <p>Lead Therapist</p>
                                                <p>Peter specializes in occupational therapy, helping children with disabilities achieve greater independence through tailored interventions.</p>
                                            </div>
